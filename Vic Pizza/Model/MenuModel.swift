...
//  Vic Pizza
//
//  Created by Sunimal Herath on 11/10/20.
...
let testMenuItem =  MenuItem(id: 1, name: "Vic Chicken", description: "Our original Hawaiian street food pizza, with chicken, onions, ginger, crushed macadamia nuts, tomato sauce, and cheese on a classic crust.", price: 14.00, rating: 6)
...
struct MenuModel{
    var menu:[MenuItem] = [
        ...
        MenuItem(id: 1, name: "Vic Chicken", description: "Our original Hawaiian street food pizza, with chicken, onions, ginger, crushed macadamia nuts, tomato sauce and cheese on a classic crust.", price: 14.00, rating: 6),
