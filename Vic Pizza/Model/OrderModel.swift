...
class OrderModel {
    ...
    /// Add an item to the order by orderitem name.
...
let testOrderItem = OrderItem(id: 1, menuID: 1, name: "VIC Chicken", comments: "Add more macadamias!", price: 9.99, size: .medium, quantity: 1)
